...
import 'package:{{package-name}}/blocs/user_profile.dart';
import 'package:{{package-name}}/developer/developer.dart';
import 'package:{{package-name}}/l10n/s.dart';
import 'package:{{package-name}}/screens/home.dart';
import 'package:{{package-name}}/screens/info.dart';
import 'package:{{package-name}}/theme.dart';
import 'package:{{package-name}}/blocs/auth.dart';
import 'package:{{package-name}}/models/models.dart';
import 'package:{{package-name}}/constants.dart';
import 'package:{{package-name}}/screens/email_password_sign_up.dart';
import 'package:{{package-name}}/screens/settings_screen.dart';
import 'package:{{package-name}}/screens/email_password_login.dart';
import 'package:{{package-name}}/screens/email_password_verification.dart';
import 'package:{{package-name}}/screens/loading.dart';

class {{name.toPascalCase()}}App extends StatelessWidget {
  final FirebaseApp firebaseApp;

  const {{name.toPascalCase()}}App({Key? key, required this.firebaseApp}) : super(key: key);
